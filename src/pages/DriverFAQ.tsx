            ...
            <div className="space-y-6">
              <Accordion type="single" collapsible className="w-full">
                ...
                <AccordionItem value="item-5" className="border-b border-gray-200">
                  <AccordionTrigger className="text-lg font-medium py-4 hover:no-underline">
                    How can I delete my driver account?
                  </AccordionTrigger>
                  <AccordionContent className="pb-4 text-gray-600">
                    <p>If you wish to delete your FemRide driver account, you can submit a deletion request through our dedicated form. Please note that this action is permanent and will remove your driver profile from our platform.</p>
                    <Link 
                      to="/delete-driver-account" 
                      className="text-[#fa9de3] hover:text-[#e989cc] font-medium mt-2 inline-block"
                    >
                      Click here to delete your driver account →
                    </Link>
                  </AccordionContent>
                </AccordionItem>
              </Accordion>

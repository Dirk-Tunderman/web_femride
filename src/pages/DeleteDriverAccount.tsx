...
const DeleteDriverAccount = () => {
  ...
  const sendEmail = async (data: DeleteAccountRequest) => {
    ...
    const templateParams = {
      ...
      subject: "FemRide Driver Account Deletion Request",
      message: `
...
This request was submitted through the FemRide Driver Account Deletion Form.
      `.trim(),
    };
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-[#fa9de3]/10 to-[#a3adf4]/20">
      ...
      <div className="pt-6 pb-10 text-center">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto text-lg px-4">
          ...
          Note that this will remove your driver profile from our platform.
        </p>
      </div>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Enter your driver account email"
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={handleChange}
                  placeholder="Please tell us why you want to delete your driver account"
                  className="rounded-xl border-gray-200 focus:border-[#fa9de3] focus:ring-[#fa9de3]"
                  required
                />
              </div>
